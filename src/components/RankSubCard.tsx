...
export default function RankSubCard() {
  ...
  return (
    <div className="bg-grayBackground rounded-lg p-6 grid grid-cols-1 gap-6 mt-6 md:mt-0">
      <div className="grid grid-cols-12 justify-between place-items-center">
        ...
        <div className="col-span-3 flex flex-row items-baseline md:-ml-10 lg:col-span-2">
        ...
        <div className="hidden lg:flex h-1/2 -m-2 justify-center items-center place-items-center  lg:col-span-3 bg-darkRed rounded-lg p-6 hover:cursor-pointer">
      ...
      <div className="lg:hidden flex h-1/2 -m-2 justify-center items-center place-items-center  lg:col-span-3 bg-darkRed rounded-lg p-6 hover:cursor-pointer">
        <p className="text-white font-bold">Learn More</p>
      </div>
    </div>
  );
